...
declare namespace React {
  ...
  interface Component<P = {}, S = {}> {
    setState<K extends keyof S>(
      state: ((prevState: Readonly<S>) => Pick<S, K> | null) | (Pick<S, K> | null),
      callback?: () => void
    ): void;
  ...
  function useReducer<R extends Reducer<any, any>, I>(
    reducer: R,
    initializerArg: I | (() => I),
    initializer?: (arg: I | (() => I)) => ReducerState<R>
  ...
  // DOM
  function createElement<P extends HTMLAttributes<T> & DOMAttributes<T>, T extends HTMLElement>(
    type: string,
    props?: P | null,
    ...children: ReactNode[]
  ): ReactElement<P, string | JSXElementConstructor<P>>;
  ...
  function createElement<P>(
    ...
    props?: P | null,
    ...children: ReactNode[]
  ): ReactElement<P, FunctionComponent<P> | ComponentClass<P> | string>;
  ...
  interface IntrinsicElements {
    ...
    data: React.DetailedHTMLProps<React.DataHTMLAttributes<HTMLElement>, HTMLElement>;
    ...
    slot: React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
  ...
  type ReactElement<P = any, T extends string | JSXElementConstructor<any> = string | JSXElementConstructor<any>> = {
    ...
    _self: ReactElement<any, any> | null;
    _source: Source | null;
  };
  type Source = {
    fileName: string;
  ...
  type FunctionComponent<P = {}> = (props: P) => ReactElement<any, any> | null;
  interface ComponentClass<P = {}, S = {}> {
    new (props: P, context?: any): Component<P, S>;
    contextType?: Context<any>;
    defaultProps?: Partial<P>;
    displayName?: string;
    getDerivedStateFromProps?: (nextProps: P, prevState: S) => Partial<S> | null;
