/**
 * Содержимое файла ReactComponentTest.tsx
 * Может быть скопировано в элемент #react-test-content
 */
const reactTestContent = `// Этот файл содержит тестовые сценарии для React/TSX кода
